...
//  GitReference
//
//  Created by Alan Barth on 3/31/15.
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        // I have no idea what this function does. It doesn't change anything when I run the simulator without it.
    }
    return self;
}
...
- (void) viewDidLoad
{
    [super viewDidLoad]; //I don't understand what this does, and why I need it. Nothing changes when I delete this and run the simulator.
    ...
    // I don't understand the alloc and init parts
    ...
    title.text = @"Git Reference";
    [scrollView addSubview: title];
    
    CGFloat top = (topMargin + heightForLabel + margin) *2;
    
    for (NSDictionary *gitCommand in [self gitCommands]) // This is confusing
    {
    ...
    scrollView.contentSize = CGSizeMake(self.view.frame.size.width, top); // Check up on this.
